...
(function () {
              ...
              value: function (e) {
                ...
                if (s && r && this.info.selector) {
                  ...
                  if (n && n.length) {
                    var o = n[0];
                    return (
                      v.test(o) && t && (o = o.replace(v, t.stringify())),
                      o
                    );
                  }
                }
            ...
            [
              {
                ...
                value: function (t, s) {
                  ...
                  return (
                    (i.font = s),
                    { width: (i.measureText(t).width + 0.5) | 0 }
                  );
                },
              },
            ],
  ...
  if (
    ...
    window.location.pathname == "/stable-penguinmod/build/editor.html"
  ) {
    showWindow();
  }
  class pangpalgemini {
