...
(function () {
  ...
  */
  ...
  function createWindow() {
    ...
    let mainWindowTitleLaber = document.createElement("label");
  ...
  async function getGeminiResponse(prompt) {
    ...
    try {
      ...
      if (sendContextCheck.checked) {
        ...
        const fileUri = `https://generativelanguage.googleapis.com/v1beta/${uploadedFileName}`;
      }
      let data;
      if (sendContextCheck.checked) {
        data = {
